...
public class GenerateTestUserSig {
     ...
     * 它是腾讯云用于区分客户的唯一标识。
     */
    public static final int SDKAPPID = Const.SDKAPPID;
     ...
     * <p>
     * 时间单位：秒
     * 默认时间：7 x 24 x 60 x 60 = 604800 = 60 天
     */
    private static final int EXPIRETIME = 5184000;//60天
     ...
     */
    private static final String SECRETKEY = Const.SECRETKEY;
